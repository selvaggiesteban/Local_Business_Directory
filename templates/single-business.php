...
if ( $post ) :
    ...
    .lbd-about-card{background:#f1f1f1;border-radius:8px;border:1px solid #ccc;padding:24px 28px}
    .lbd-about-card .lbd-single-content{font-size:24px;font-weight:500;line-height:1.3em;color:#1f2937}
    </style>';
    $post_id    = $post->ID;
...
?>
    ...
    <div class="lbd-single-contact-bar">
        ...
        <?php endif; ?>
        <?php if ( $whatsapp ) : ?>
            <a href="https://wa.me/<?php echo esc_attr( $whatsapp ); ?>?text=<?php echo $wa_msg; ?>" target="_blank" rel="noopener" class="lbd-single-contact-item whatsapp">
